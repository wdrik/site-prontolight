			...
			<div class="error-404 not-found">
				...
				<div class="page-content">
					...
					'<section class="wrapper-404">
						<div class="wrapper-404__left">
							<img src="'.get_site_url().'/wp-content/uploads/2018/08/logo-prontolight.png" alt="Pronto Light">
						</div>

						<div class="wrapper-404__right">
							<h3>404</h3>
							<p>Página não encontrada!</p>
							<a href="'.get_site_url().'" class="button">Volte para a home</a>
						</div>
					</section>';
