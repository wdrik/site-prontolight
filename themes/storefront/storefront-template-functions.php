				...
				echo '<div class="home-feature-product__column">';
					...
					echo
						'<p class="content-featured-product__description">
							São 21 dias com TODAS as refeições (café da manhã, lanches, almoço e jantar). <br>
							O cardápio é feito com base em suas necessidades e preferências. Se você quer emagrecer, clique abaixo
						</p>';
