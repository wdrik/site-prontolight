...
add_action( 'homepage', 'storefront_homepage_custom_slider', 0 );
add_action( 'homepage', 'storefront_homepage_custom_features_home',      10 );
add_action( 'homepage', 'storefront_homepage_custom_program_tabs',    20 );
add_action( 'homepage', 'storefront_homepage_custom_products_tabs',    20 );
add_action( 'homepage', 'storefront_homepage_custom_feature_product',       30 );
