...
if ( ! function_exists( 'storefront_credit' ) ) {
	...
	function storefront_credit() {
		...
		R. Abílio Borin, 35 - Jardim Caravelas, São Paulo - SP, 04729-030
...
if ( ! function_exists( 'storefront_homepage_custom_features_home' ) ) {
	...
	function storefront_homepage_custom_features_home() {
		echo
			'<section class="features-home">
				<div class="col-full">
					<div class="table-row">
						...
						<p class="text-bold text-italic">Peça hoje e receba amanhã*</p>
						</div>
						<div class="table-row__column features-home__column">
						<img src="wp-content/themes/prontolight-child/assets/images/entrega-todososdias.png">
						<p class="text-bold text-italic">Entregas de segunda a sábado*</p>
						</div>
						<div class="table-row__column features-home__column">
						<img src="wp-content/themes/prontolight-child/assets/images/entrega-noturna.png">
						<p class="text-bold text-italic">Entrega noturna das 20h ás 23h*</p>
						</div>
					</div>
				</div>
			</section>
			...
			<div class="col-full">
				<span class="span--info">*Condições válidas para São Paulo Capital e Grande São Paulo.</span>
			</div>
			';
	}
}
				...
				echo
					'<div class="tab-custom">
						<ul class="tabs-custom">
							...
							<li id="porcoes"><a href="#" class="tab-link">Porções</a></li>
				...
				echo '<div class="home-feature-product__column">';
					...
					echo
						'<p class="content-featured-product__description">
							O WLT é um kit completo de emagrecimento, composto de Refeições Saudáveis entregues na sua casa. São 21 dias com TODAS as refeições saudáveis (café da manhã, lanches, almoço e jantar). <br>
							O cardápio é feito com base em suas necessidades e preferências.  Descubra como pessoas emagrecem até 8 kilos em 3 semanas e como você também pode fazer o mesmo. Se você quer emagrecer, clique abaixo
						</p>';
					...
					<div class="custom-row">
						...
						<div class="custom-col-4">
							<div class="box-depoimento">
								...
								<h3>Ana Carolina</h3>
								<p style="color: #6d6d6d; font-size: 14px;">"Consegui finalmente seguir uma alimentação saudável e variada nutricionalmente, conforme minha necessidade direcionada aos meus treinos."</p>
							</div>
						</div>
						...
						<div class="custom-col-4">
							<div class="box-depoimento">
								...
								<h3>Higor</h3>
								<p style="color: #6d6d6d; font-size: 14px;">"Por onde começar? Comida? Sabor? Embalagem ? Atendimento? Praticidade? Já utilizo a Pronto Light há 3 meses e super recomendo! O sabor é incrível, a embalagem uma facilidade, o atendimento impecável!" </p>
							</div>
						</div>
...
//sobre
    ...
    font-weight: 500; position: relative;     margin-top: -15px; text-transform: uppercase;">Delivery de Comida Congelada Saudável em SP</h1>

					<p style="color: #6d6d6d; font-size: 14px;">Vivemos com objetivo de mudar a vida das pessoas através de uma <strong>alimentação equilibrada, saudável</strong> e extremamente prática. O que fazemos de tão diferente? Buscamos sempre novas formas de trazer praticidade para o seu dia-a-dia, comida gostosa e que faz bem para a saúde. Sabemos da importância de sempre inovar, de trazer uma experiência cada vez melhor para os nossos clientes através da nossa experiência. Na correria diária muitas pessoas não tem tempo para cozinhar, ou sequer gostam, mas sabem a importância da comida de qualidade, do poder transformador da comida.  Oferecemos uma enorme variedade de comidas congeladas saudáveis, você escolhe o que te atende: comida para o dia a dia, <strong>programas de emagrecimento</strong>, kits detox, low carb, marmitas fitness, doces fitness, sucos saudáveis, lanches e snack. Nossa comida é feita com muito sabor e carinho. Embaladas em porções individuais e a vácuo garantindo a conservação natural dos alimentos, além da qualidade. É a tecnologia presente em nossa cozinha. Temos tanta certeza que você vai gostar que garantimos: se não gostar de algum prato, mandamos outro para você! </p>
				</div>
				<div class="col-full">
    ...
    font-weight: 500;">O que é uma alimentação saudável?<i class="fas fa-angle-down"></i></h3>
								<div><p style="color: #6d6d6d; font-size: 14px;">Uma alimentação equilibrada e que faz bem para saúde é aquela que atende às necessidades do organismo.
<br><br>
Não basta apenas a comida ser saudável, ela precisa respeitar a tradição alimentar, trazer releituras e ingredientes que façam sua refeição ser saborosa! Sabe aquele gostinho de quero mais?
<br><br>
A pronto Light está aqui para te ajudar nesse estilo de vida. Nós fazemos o possível ( e até tentamos o impossível) para incentivar a comida saudável. Os ingredientes são selecionados, orgânicos, in natura ou minimamente processados, como recomendado pelos especialistas, mas sempre com criatividade.
<br><br>

É o melhor dos mundos, sabor, afeto e praticidade e entregue na porta da sua casa. Pra nós, o único caminho para o sucesso é fazer as escolhas certas, sempre com o foco na saúde.
 ...
 <i class="fas fa-angle-down"></i></h3>
								<div><p style="color: #6d6d6d; font-size: 14px;">Comida é a chave para sua saúde, emagrecer não é o único objetivo.  Ter hábitos saudáveis é o melhor investimento para sua saúde.  Nem sempre temos tempo passar horas na cozinha, no entanto, sabemos sabem a importância da comida de qualidade, do poder transformador da comida, mas isso não é desculpa para se alimentar mal, uma alternativa são as comidas prontas congeladas saudáveis.  Tenha sempre à mão a melhor escolha: Pronto Light. Comida de verdade, sem conservantes, com muito sabor e praticidade.
    ...
    font-weight: 500;">Como funciona? <i class="fas fa-angle-down"></i></h3>
								<div><p style="color: #6d6d6d; font-size: 14px;">Temos pratos pré-montados, ou porções individuais, com as quais você pode montar sua própria combinação. O pedido pode ser agendado para entrega no mesmo dia ou para outra data.</p></div>
							</div>
    ...
    font-weight: 500;">Entrega de Comida Congelada<i class="fas fa-angle-down"></i></h3>
								...
								O Ultra Congelamento, é a melhor forma de garantir a conservação natural dos alimentos, além da qualidade. É a tecnologia presente em nossa cozinha.
<br><br>
Na pressa, não precisa recorrer ao fast food. Você tem uma alternativa muito mais saudável e prática. Unimos o melhor dos mundos: comida boa, prática e nutritiva entregue em casa.
<br><br>
Comida saudável, igual àquela feita em casa, sem conservantes artificiais, sem sódio em excesso, como aquela que você encontra nos supermercados e que podem até fazer mal pra saúde. Entrega rápida de comida saudável congelada é diferente porque é feita com alimentos frescos, com uma validade menor, mas com certeza um prato quase feito na hora.
							...
							<div class="box-accordion">
								<h3 onclick="jQuery(\'+div\',this).toggle(500);"style="    color: #174063; font-size: 15px;
    font-weight: 500;">Por que embalamos a vácuo as Comidas Congeladas?
 <i class="fas fa-angle-down"></i></h3>
								<div><p>O vácuo tira todo o ar do alimento no momento que é embalado, isso evita formar aqueles cristais de gelo que vemos em Marmitas Fitness tradicionais. O resultado é uma comida deliciosa, sem aquele gelo que vira água e estraga o sabor e textura dos alimentos.
							...
							<div class="box-accordion">
								<h3 onclick="jQuery(\'+div\',this).toggle(500);"style="    color: #174063; font-size: 15px;
    font-weight: 500;">Entrega em São Paulo SP e Região<i class="fas fa-angle-down"></i></h3>
								<div><p>Entregamos em São Paulo e região.<br><br>
								É muito simples! Você têm 3 horários de entrega:<br>

Manhã – Entre 09:00 e 12:00;<br>
Tarde – Entre 12 e 17 horas;<br>
Noite – Entre 20 e 23 horas.
<br><br>
Entregas de segunda a sábado*</p></div>
							</div>
						</div>
					</div>
				</div>
