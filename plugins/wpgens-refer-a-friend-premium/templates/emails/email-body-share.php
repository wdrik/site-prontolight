                ...
                <tbody>
                    <tr>
                        <td align="center" width="200" height="40" bgcolor="<?php echo $color;?>" style="-webkit-border-radius: 5px; -moz-border-radius: 5px; border-radius: 5px; color: #ffffff; display: block;">
                            <a href="<?php echo $refLink; ?>" style="font-size:16px; font-weight: bold; font-family: Helvetica, Arial, sans-serif; text-decoration: none; text-transform:uppercase;line-height:40px; width:100%; display:inline-block"><span style="color: #FFFFFF"><?php _e('Quero Agora','gens-raf'); ?></span></a>
                        </td>
                    </tr>
                </tbody>
            </table>
