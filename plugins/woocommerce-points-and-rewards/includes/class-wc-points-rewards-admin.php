	...
	public static function get_settings() {
		...
		$settings = array(
			...
			array(
				...
				'css'      => 'min-width: 400px;',
				'default'  => sprintf( __( 'Complete your order and earn %s for a discount on a future purchase', 'woocommerce-points-and-rewards' ), '<strong>{points_value}</strong> {points_label}' ),
				'type'     => 'textarea',
			),
